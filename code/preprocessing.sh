...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --lowercase --tokenize --lemmatize --stem --stopwords -e data/preprocessing/pipeline.pickle
