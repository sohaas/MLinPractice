...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --handle_values --links --punctuation --lowercase --tokenize --stopwords --stem --extract -e data/preprocessing/pipeline.pickle
