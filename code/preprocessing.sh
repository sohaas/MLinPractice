...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --handle_values --punctuation --lowercase --tokenize --lemmatize --stem -e data/preprocessing/pipeline.pickle
