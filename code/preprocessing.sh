...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --lowercase --tokenize --lemmatize -e data/preprocessing/pipeline.pickle
