...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --handle_values --links --punctuation --lowercase --tokenize --stopwords --stem -e data/preprocessing/pipeline.pickle
