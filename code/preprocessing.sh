...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --lowercase --tokenize --stopwords --stem -e data/preprocessing/pipeline.pickle
